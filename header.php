...
<nav class="w-100pc flex flex-column md-flex-row md-px-10 px-2 py-5 bg-black">
    ...
    <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
        ...
        <!--<a href="gallery.php" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Gallery</a>-->
        <a href="testing.php" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Testing</a>
